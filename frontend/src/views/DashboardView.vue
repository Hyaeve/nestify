...
.dashboard-hero {
  ...
  padding: 30px 36px;
  border-radius: 30px;
  border: 1px solid rgba(32, 159, 238, 0.2);
  color: #0f172a;
  background:
    linear-gradient(rgba(32, 159, 238, 0.045) 1px, transparent 1px),
    linear-gradient(90deg, rgba(32, 159, 238, 0.045) 1px, transparent 1px),
  ...
  box-shadow: 0 18px 42px rgba(32, 159, 238, 0.08);
}
...
.summary-item__dot {
  ...
  border-radius: 999px;
  background: #209fee;
  box-shadow: 0 0 0 5px rgba(32, 159, 238, 0.12);
}
