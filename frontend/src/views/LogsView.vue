...
.logs-hero {
  ...
  color: #0f172a;
  background:
    linear-gradient(rgba(25, 129, 163, 0.04) 1px, transparent 1px),
    linear-gradient(90deg, rgba(25, 129, 163, 0.04) 1px, transparent 1px),
    ...
    linear-gradient(100deg, #f2f9fb 0%, #ffffff 46%, #eef4f7 100%);
  background-size: 54px 54px, 54px 54px, auto, auto, auto;
  box-shadow: 0 18px 42px rgba(25, 129, 163, 0.1);
}
...
.logs-hero::after {
  ...
  height: 260px;
  border-radius: 999px;
  background: radial-gradient(circle, rgba(25, 129, 163, 0.12), transparent 66%);
  content: '';
}
...
.logs-action--sort {
  ...
  min-width: 42px;
  color: #0d5973;
  background: rgba(25, 129, 163, 0.2);
}

.logs-action--sort {
  border: 1px solid rgba(25, 129, 163, 0.16);
