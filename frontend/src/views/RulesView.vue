...
.history-sort-order-button:not(.is-disabled):hover { color: #0d5973; border-color: rgba(25, 129, 163, 0.42); background: rgba(25, 129, 163, 0.14); box-shadow: 0 12px 24px rgba(15, 23, 42, 0.1); transform: translateY(-1px); }
...
.detail-backup__title { font-size: 14px; font-weight: 800; color: #0d5973; }
...
.rule-card-grid .rule-sortable-chosen {
  ...
  box-shadow: 0 14px 30px rgba(25, 129, 163, 0.22);
}
