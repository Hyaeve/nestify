...
.result-item:hover {
  border-color: rgba(32, 159, 238, 0.32);
...
.folder-child-item:hover {
  border-color: rgba(32, 159, 238, 0.28);
...
.rail-arrow {
  ...
  color: #0975b8;
  border-radius: 24px;
  background: linear-gradient(135deg, rgba(32, 159, 238, 0.16), rgba(32, 159, 238, 0.08));
  border: 1px solid transparent;
}
...
.rule-nav-item.is-active {
  color: #0975b8;
  background: rgba(32, 159, 238, 0.11);
}

.rule-nav-item.is-active {
  box-shadow: inset 3px 0 0 #209fee;
}
...
.rule-set-card.is-active {
  color: #0975b8;
  border-color: rgba(32, 159, 238, 0.26);
