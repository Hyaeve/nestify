...
.pane-count {
  ...
  border-radius: 999px;
  color: #3f6c7d;
  background: rgba(107, 159, 176, 0.1);
  font-size: 12px;
  font-weight: 700;
}
...
.result-item:hover {
  border-color: rgba(107, 159, 176, 0.32);
...
.folder-child-item:hover {
  border-color: rgba(107, 159, 176, 0.28);
...
.rail-arrow {
  ...
  color: #3f6c7d;
  border-radius: 24px;
  background: linear-gradient(135deg, rgba(107, 159, 176, 0.16), rgba(107, 159, 176, 0.08));
  border: 1px solid transparent;
}
...
.rule-nav-item.is-active {
  color: #3f6c7d;
  background: rgba(107, 159, 176, 0.11);
}

.rule-nav-item.is-active {
  box-shadow: inset 3px 0 0 #6b9fb0;
}
...
.rule-set-card.is-active {
  color: #3f6c7d;
  border-color: rgba(107, 159, 176, 0.26);
