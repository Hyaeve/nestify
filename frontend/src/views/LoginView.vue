    ...
    <el-card class="login-card">
      <div class="login-brand">
        ...
        <div>
          ...
          <div class="login-brand__subtitle">媒体归档管理台</div>
        </div>
      </div>
...
.login-brand__logo {
  ...
  border-radius: 16px;
  object-fit: cover;
  box-shadow: 0 18px 42px rgba(32, 159, 238, 0.12);
}
...
:deep(.el-input__wrapper.is-focus) {
  box-shadow:
    0 0 0 1px rgba(32, 159, 238, 0.72) inset,
    0 10px 28px rgba(32, 159, 238, 0.12);
}
...
.login-button {
  ...
  border: 0;
  border-radius: 14px;
  background: linear-gradient(135deg, #73b5de 0%, #209fee 100%);
  box-shadow: 0 16px 34px rgba(32, 159, 238, 0.18);
  font-weight: 800;
}
