...
.backup-card:hover {
  border-color: #b6c5c9;
  box-shadow: 0 10px 22px rgba(25, 129, 163, 0.08);
}
...
.backup-card--chosen {
  border-color: #8fb2c0;
  box-shadow: 0 6px 16px rgba(25, 129, 163, 0.12);
}
...
.backup-filter-chip.is-active {
  color: #074154;
  background: rgba(25, 129, 163, 0.18);
  border-color: rgba(25, 129, 163, 0.55);
}

.backup-filter-chip.is-active:hover {
  color: #074154;
  background: rgba(25, 129, 163, 0.3);
  border-color: rgba(25, 129, 163, 0.78);
}
